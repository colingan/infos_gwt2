...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "infos_gwt" because\n';
  ...
  $wnd.__gwt_activeModules['infos_gwt'] = {
    'moduleName' : 'infos_gwt',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/infos_gwt.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['infos_gwt'].superdevmode = true;

  var expectedSuffix = '/infos_gwt.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + infos_gwt + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:infos_gwt';
  var devModeSessionKey = '__gwtDevModeSession:infos_gwt';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/infos_gwt/infos_gwt.nocache.js';
  ...
  $wnd.__gwt_activeModules['infos_gwt'].canRedirect = true;
  $wnd.__gwt_activeModules['infos_gwt'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/infos_gwt?user.agent=' + ua + '&_callback=' + callback;
